...
garbage in each dumpster that was collected. the precipitation data set
has data on the total precipitation in Baltimore each month. There are
344 observations in the final trash wheel data set, and 24 observations
in the final precipitation data set.

Key variables are dumpster, homes\_powered, weight\_tons, and total
precipitation.
